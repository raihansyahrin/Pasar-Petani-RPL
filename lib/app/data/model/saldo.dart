...
class Saldo {
    ...
    factory Saldo.fromJson(Map<String, dynamic> json) => Saldo(
        ...
        historyPenarikan: json["history_penarikan"] == null ? [] : List<HistoryPenarikan>.from(json["history_penarikan"]!.map((x) => HistoryPenarikan.fromJson(x))),
        historyPemasukan: json["history_pemasukan"] == null ? [] : List<HistoryPemasukan>.from(json["history_pemasukan"]!.map((x) => HistoryPemasukan.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "history_penarikan": historyPenarikan == null ? [] : List<dynamic>.from(historyPenarikan!.map((x) => x.toJson())),
        "history_pemasukan": historyPemasukan == null ? [] : List<dynamic>.from(historyPemasukan!.map((x) => x.toJson())),
    };
}
...
class HistoryPemasukan {
    ...
    factory HistoryPemasukan.fromJson(Map<String, dynamic> json) => HistoryPemasukan(
        id: json["id"],
        idUang: json["id_uang"],
...
class HistoryPenarikan {
    ...
    factory HistoryPenarikan.fromJson(Map<String, dynamic> json) => HistoryPenarikan(
        id: json["id"],
        idUang: json["id_uang"],
        nominalPenarikan: json["nominal_penarikan"],
        waktuPenarikan: json["waktu_penarikan"] == null ? null : DateTime.parse(json["waktu_penarikan"]),
        createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
        updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
    );
